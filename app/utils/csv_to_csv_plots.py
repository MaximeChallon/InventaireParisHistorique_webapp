...
with open('/home/maxime/Documents/PH/Inventaire/inventaire_complet_pipe.csv', 'r') as f:
	with open('/home/maxime/Bureau/inventaire_complet.csv', "w") as f_e:
		...
		f_csv.writerow(["N_inventaire", "Rue", "N_rue", "Nom_site", "Arrondissement", "Ville", "Latitude_x", "Longitude_y", "Support", "Couleur", "Taille", "Date_prise_vue", "Photographe", "Date_construction", "Architecte", "Classement_MH", "Generalite_architecture", "Mot_cle1", "Mot_cle2", "Mot_cle3", "Mot_cle4", "Mot_cle5", "Mot_cle6", "Cote_base", "Cote_classement", "Date_inventaire"])
		for row in f_o:

...
def cataloguer():
    ...
    if form.validate_on_submit():
        nouvelle_photo = Classe_catalogage(
            ...
            Notes = ((("[Numéro d'inventaire lié: " + (str(form.N_inventaire_lie.data))  + "]" )if (form.N_inventaire_lie.data != '0' and form.N_inventaire_lie.data != None and form.N_inventaire_lie.data != '') else "") + form.Notes.data),
...
def editer_photographie( id_photo):
    ...
    if form.validate_on_submit():
        ...
        photo.Notes = ((("[Numéro d'inventaire lié: " + (str(form.N_inventaire_lie.data))  + "]" )if (form.N_inventaire_lie.data != '0' and form.N_inventaire_lie.data != None and form.N_inventaire_lie.data != '') else "") + form.Notes.data)
